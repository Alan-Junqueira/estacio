...
# tk.Button(janela, text='Sair', command=janela.quit).grid(
#     row=3, column=0, sticky=tk.W, pady=4)
# tk.Button(janela, text='Exibir Dados', command=mostrar_nomes).grid(
...
# janela = tk.Tk()
# v = tk.IntVar()
# tk.Label(janela, text="""Escolha uma linguagem de programação:""",
#          justify=tk.LEFT, padx=20).pack()
# tk.Radiobutton(janela, text="python", padx=25,
#                variable=v, value=1).pack(anchor=tk.W)
# tk.Radiobutton(janela, text="C++", padx=25,
#                variable=v, value=2).pack(anchor=tk.W)
# janela.mainloop()
...
# var1 = tk.IntVar()
# ttk.Checkbutton(janela, text="Gerencial",
#                 variable=var1).grid(row=1, sticky=tk.W)
# var2 = tk.IntVar()
# ttk.Checkbutton(janela, text="Técnica", variable=var2).grid(row=2, sticky=tk.W)
# ttk.Button(janela, text='Sair', command=janela.quit).grid(
#     row=3, sticky=tk.W, pady=4)
# ttk.Button(janela, text='Mostrar', command=escolha_carreira).grid(
...
# Componente Label
ttk.Label(janela, text="Combobox Widget", background='green',
          foreground="white", font=("Times New Roman", 15)).grid(row=0, column=1)
# Componente Label
ttk.Label(janela, text="Selecione um mês :", font=(
